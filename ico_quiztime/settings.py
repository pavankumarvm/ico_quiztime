"""
Django settings for ico_quiztime project.
...
ALLOWED_HOSTS = ['icoquiztime.com','www.icoquiztime.com','3.110.84.157', '*']
...
ROOT_URLCONF = 'ico_quiztime.urls'
...
WSGI_APPLICATION = 'ico_quiztime.wsgi.application'
